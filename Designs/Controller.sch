...
<part name="POWER-FLOPPY" library="pinhead" deviceset="PINHD-1X4" device=""/>
...
<part name="USB-TTL" library="pinhead" deviceset="PINHD-1X4" device=""/>
<part name="R4" library="adafruit" deviceset="R-US_" device="0207/10" value="100R"/>
<part name="R5" library="adafruit" deviceset="R-US_" device="0207/10" value="1K7"/>
<part name="R6" library="adafruit" deviceset="R-US_" device="0207/10" value="1K7"/>
<part name="R7" library="adafruit" deviceset="R-US_" device="0207/10" value="1K7"/>
<part name="R8" library="adafruit" deviceset="R-US_" device="0207/10" value="1K7"/>
...
<part name="R17" library="adafruit" deviceset="R-US_" device="0207/10" value="1K"/>
<part name="FAN_PWM1_1" library="pinhead" deviceset="PINHD-1X3" device=""/>
<part name="FAN_PWM2_1" library="pinhead" deviceset="PINHD-1X3" device=""/>
<part name="FAN_PWM1_2" library="pinhead" deviceset="PINHD-1X3" device=""/>
<part name="FAN_PWM2_2" library="pinhead" deviceset="PINHD-1X3" device=""/>
<part name="LED_CONNECTOR" library="pinhead" deviceset="PINHD-1X4" device=""/>
...
<sheet>
<plain>
<text x="124.46" y="-30.48" size="2.54" layer="90">DESIGN BY:
Salik Sadruddin Merani
twitter: echo_salik
facebook: Salik.Sadruddin

I am realeasing this image under the Creative
Common License. Please dont forget to give 
credit where due.</text>
<text x="-109.22" y="2.54" size="2.1844" layer="91">LED transistors can be changed to 2N2222 as LEDs
dont draw much current. If your LED array is drawing
less then 500mA then you can use 2N2222.
If it is more then 500mA then prefer using  BD139 or
anyother power transistor. MOSFETs would be overkill.</text>
<text x="-109.22" y="25.4" size="2.1844" layer="91">FAN transistors can be changed to MOSFETs but I
have these lying around with a current limit of 4A,
way more then a fan can draw, so I am using this.</text>
<text x="-109.22" y="-22.86" size="2.1844" layer="91">LCD can be replaced with anything you want.
I already have a Nokia 1202/1280 LCD in my stash
so I am using that. It is a 9 Bit SPI LCD 
and it works at 3.3V. The Pins connected are 
not SPI Pins because ATMega328p doesnt support 
9 Bit SPI by default, a custom library will be used.</text>
<text x="-109.22" y="-40.64" size="2.1844" layer="91">You can replace ATmega with a Arduino Nano.
It will be a better alternative. I dont intend to buy one
So I'll be using the IC. Using Nano would remove 
the need to have a 3.3V Regulator.</text>
<text x="-17.78" y="-35.56" size="2.1844" layer="91">All the Transistors are BD435. I could not find the
part in Eagle so used a similar one.</text>
</plain>
<instances>
<instance part="U1" gate="G$1" x="5.08" y="12.7"/>
<instance part="Q1" gate="G$1" x="-22.86" y="10.16" rot="R90"/>
<instance part="C1" gate="G$1" x="-25.4" y="20.32" rot="R270"/>
<instance part="C2" gate="G$1" x="-25.4" y="0" rot="R270"/>
<instance part="POWER-FLOPPY" gate="A" x="-45.72" y="50.8" rot="R90"/>
<instance part="IC1" gate="G$1" x="10.16" y="73.66"/>
<instance part="LCD1" gate="G$1" x="81.28" y="58.42"/>
...
<instance part="R3" gate="G$1" x="53.34" y="66.04" rot="R90"/>
<instance part="USB-TTL" gate="A" x="48.26" y="10.16"/>
...
<instance part="R6" gate="G$1" x="35.56" y="35.56" smashed="yes" rot="R180">
...
<instance part="R7" gate="G$1" x="35.56" y="33.02" smashed="yes" rot="R180">
...
<instance part="R8" gate="G$1" x="35.56" y="30.48" smashed="yes" rot="R180">
...
<instance part="R9" gate="G$1" x="38.1" y="43.18" smashed="yes" rot="R180">
...
<instance part="R10" gate="G$1" x="38.1" y="45.72" smashed="yes" rot="R180">
...
<instance part="R11" gate="G$1" x="38.1" y="48.26" smashed="yes" rot="R180">
...
<instance part="R12" gate="G$1" x="38.1" y="50.8" smashed="yes" rot="R180">
...
<instance part="T2" gate="G$1" x="99.06" y="22.86"/>
<instance part="R13" gate="G$1" x="81.28" y="15.24" rot="R270"/>
<instance part="R14" gate="G$1" x="96.52" y="15.24" rot="R270"/>
<instance part="T3" gate="G$1" x="121.92" y="22.86"/>
<instance part="T4" gate="G$1" x="132.08" y="22.86"/>
<instance part="T5" gate="G$1" x="142.24" y="22.86"/>
<instance part="R15" gate="G$1" x="119.38" y="15.24" rot="R270"/>
<instance part="R16" gate="G$1" x="129.54" y="15.24" rot="R270"/>
<instance part="R17" gate="G$1" x="139.7" y="15.24" rot="R270"/>
<instance part="FAN_PWM1_1" gate="A" x="83.82" y="-5.08" smashed="yes" rot="R270">
<attribute name="NAME" x="62.23" y="-4.445" size="1.778" layer="95"/>
<attribute name="VALUE" x="76.2" y="1.27" size="1.778" layer="96" rot="R270"/>
</instance>
<instance part="FAN_PWM2_1" gate="A" x="99.06" y="-5.08" smashed="yes" rot="R270">
<attribute name="NAME" x="105.41" y="-4.445" size="1.778" layer="95"/>
<attribute name="VALUE" x="91.44" y="1.27" size="1.778" layer="96" rot="R270"/>
</instance>
<instance part="FAN_PWM1_2" gate="A" x="83.82" y="-15.24" smashed="yes" rot="R270">
<attribute name="NAME" x="62.23" y="-14.605" size="1.778" layer="95"/>
<attribute name="VALUE" x="76.2" y="-8.89" size="1.778" layer="96" rot="R270"/>
</instance>
<instance part="FAN_PWM2_2" gate="A" x="99.06" y="-15.24" smashed="yes" rot="R270">
...
<instance part="LED_CONNECTOR" gate="A" x="134.62" y="45.72" rot="R90"/>
<instance part="D3" gate="G$1" x="101.6" y="-20.32" rot="R90"/>
<instance part="D4" gate="G$1" x="86.36" y="-20.32" rot="R90"/>
</instances>
<busses>
</busses>
<nets>
...
<segment>
<pinref part="POWER-FLOPPY" gate="A" pin="2"/>
...
<pinref part="POWER-FLOPPY" gate="A" pin="3"/>
...
<pinref part="FAN_PWM1_2" gate="A" pin="1"/>
...
<pinref part="FAN_PWM2_1" gate="A" pin="1"/>
...
<pinref part="FAN_PWM2_2" gate="A" pin="1"/>
...
<segment>
<pinref part="LED_CONNECTOR" gate="A" pin="1"/>
...
<net name="5V" class="0">
<segment>
<pinref part="POWER-FLOPPY" gate="A" pin="1"/>
...
<segment>
<pinref part="LED_CONNECTOR" gate="A" pin="2"/>
...
<segment>
<pinref part="LED_CONNECTOR" gate="A" pin="3"/>
...
<segment>
<pinref part="LED_CONNECTOR" gate="A" pin="4"/>
...
<pinref part="FAN_PWM1_2" gate="A" pin="2"/>
<pinref part="FAN_PWM1_1" gate="A" pin="2"/>
...
<pinref part="FAN_PWM2_2" gate="A" pin="2"/>
<pinref part="FAN_PWM2_1" gate="A" pin="2"/>
